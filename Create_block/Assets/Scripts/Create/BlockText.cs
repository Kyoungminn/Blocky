...
public class BlockText : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        Create blockInstance = GameObject.Find("GameManager").GetComponent<Create>(); //GameManager에 있는 Create스크립트의 blockPrefab 변수 사용(특히, transform)
        parent = blockInstance.blockPrefab.GetComponent<Transform>(); //parent에 blockPrefab의 transform 대입
    }
